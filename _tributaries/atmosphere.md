...
{% include feature/trib-button.html trib="land/#sedimentation" image="land" text="Earthly Archives" %}
...
{% include feature/trib-button.html trib="humans/#proliferations" image="microbes" text="Entangled Stories" %}
...
{% include feature/trib-button.html trib="biota/#lifeboats" image="microbes" text="Potholes" %}
...
{% include feature/trib-button.html trib="land/#terrainfirma" image="twinbuttes" text="Terra Infirma" %}
...
{% include feature/trib-button.html trib="land/#natureisfuckinglit" image="balancedrock" text="Archives of Animacy" %}
...
{% include feature/trib-button.html trib="land/#stantons-dredge" image="mining" text="Dredge Economies" %}
...
{% include feature/trib-button.html trib="land/#the-dominy-formation" image="infrastructure" text="Reclamation" %}
...
{% include feature/trib-button.html trib="biota/#lines-of-flight" image="vegetation" text="Disorder" %}
...
{% include feature/trib-button.html trib="water/#drought" image="water" text="Water" %}
...
{% include feature/trib-button.html trib="humans/#remains-of-the-future" image="uranium" text="Future Ruins" %}
...
{% include feature/trib-button.html trib="biota/#cryptobiotics" image="microbes" text="Desert Crust" %}
