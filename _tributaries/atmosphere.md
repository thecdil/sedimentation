...
{% include feature/trib-button.html trib="land/#sedimentation" image="land" text="Sedimentation" %}
...
{% include feature/trib-button.html trib="humans/#proliferations" image="microbes" text="Proliferations" %}
...
{% include feature/trib-button.html trib="land/#grammars-of-animacy" image="volcano" text="Grammars of Animacy" %}
...
{% include feature/trib-button.html trib="biota/#mezosoic-lifeboats" image="microbes" text="Mezosoic Lifeboats" %}
...
One Diné elder[^7] explains that the traces of níłch’i can be seen within the swirls on our fingertips and toes, and in the coils of our ears and hair:
...
{% include feature/trib-button.html trib="land/#terra-infirma" image="twinbuttes" text="Terra Infirma" %}
...
{% include feature/trib-button.html trib="humans/#inscriptions" image="tracks" text="Inscriptions" %}
...
{% include feature/trib-button.html trib="land/#natureisfuckinglit" image="balancedrock" text="NatureisFuckingLit" %}
...
{% include feature/image-gallery.html objectid="sediment154" caption="Katie Lee, lying in a bed of rocks"%}
...
{% include feature/image-gallery.html objectid="sediment5" caption="Tad Nichols in Dungeon Canyon"%}
...
{% include feature/trib-button.html trib="humans/#palimpsests" image="exploration" text="Palimpsests" %}
...
{% include feature/image-gallery.html objectid="sediment103" caption="Byron Cummings at Rainbow Bridge"%}
...
{% include feature/trib-button.html trib="humans/#rainbow-bridge" image="balancedrock" text="Rainbow Bridge " %}
...
{% include feature/image-gallery.html objectid="sediment158" caption="Tourist boat at Rainbow Bridge"%}
...
{% include feature/trib-button.html trib="land/#stantons-dredge" image="mining" text="Stanton's Dredge" %}
...
{% include feature/image-gallery.html objectid="sediment114" caption="Upper Glen Canyon"%}
...
{% include feature/image-gallery.html objectid="sediment140" caption="Glen Canyon Dam construction"%}
...
{% include feature/trib-button.html trib="land/#the-dominy-formation" image="infrastructure" text="The Dominy Formation" %}
...
{% include feature/trib-button.html trib="biota/#lines-of-flight" image="vegetation" text="Lines of Flight" %}
...
## Radium Dust
{% include feature/image-gallery.html objectid="sediment60" caption="Uranium mining at Lukachukais"%}
...
{% include feature/trib-button.html trib="humans/#remains-of-the-future" image="uranium" text="Remains of the Future" %}

{% include feature/new-section.html %}

## Feedback Loops

{% include feature/image-gallery.html objectid="sediment155" caption="Mud volcano"%} 
...
{% include feature/trib-button.html trib="atmosphere" image="atmosphere" text="Recirculate" %}
